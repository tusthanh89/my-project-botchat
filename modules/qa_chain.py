...
def ask_with_context(question, k=3):
    ...
    if not context.strip():
        ...
        prompt = f"""Bạn trả lời ngắn gọn, dễ hiểu, không cần chào hỏi đầu câu sau khi đã chào lần đầu tiên, khi chào thì giới thiệu luôn ,chỉ tập trung vào nội dung câu hỏi.
Câu hỏi: {question}
Trả lời:"""
    else:
        # Nếu có context, yêu cầu trả lời dựa trên context
        prompt = f"""Bạn trả lời ngắn gọn, không cần chào hỏi đầu câu sau khi đã chào lần đầu tiên, khi chào thì giới thiệu luôn ,dễ hiểu, chỉ tập trung vào nội dung câu hỏi, lịch sự,
